...
platform8 = Rect((0,100) , (100,10))#stop far left
platform9 = Rect((900,100) , (100,10))#stop far right
...
def backgroundcolorfade():
    global blue, bluefoward
    if blue < 255 and bluefoward:
        blue += 1
    else:
        bluefoward= False
    if blue > 130 and not bluefoward:
        blue -= 1
    else:
        bluefoward = True